...
export async function POST(req: Request) {
  ...
  try {
    await twilioClient.messages.create({
      ...
      body: [
        "郷家にお電話ありがとうございます。",
        "ただいま電話に出ることができず申し訳ございません。",
        "折り返しご連絡いたしますので、少々お待ちください。",
        "",
        "——————————",
        "",
        "【本店】泡盛と沖縄料理 郷家",
        "📞 予約: https://zumi-goya.com/contact/",
        "🕠 17:30〜22:00（L.O. 21:00）",
        "",
        "【はなれ】郷家はなれ（2F）",
        "📞 予約: https://zumi-goya.com/hanare/#hanare_form",
        "🕠 18:00〜23:00（L.O. 21:00）",
        "",
        "——————————",
        "",
        "🍽 メニュー: https://zumi-goya.com/menu/",
        "📍 アクセス: https://zumi-goya.com/access/",
        "🎵 ライブ三線: 毎日 19:00〜",
        "",
        "🅿️ 駐車場: 店前10台（先着順）",
        "※満車の場合、徒歩4〜8分圏内にコインパーキングがございます。",
        "",
        "——————————",
        "TEL: 0980-74-2358",
        "〒906-0012 宮古島市平良西里570-2",
      ].join("\n"),
    });
